...
public class LastFence  extends AppCompatActivity
        implements
    ...
    private static final String TAG = LastFence.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last_fence);
        ...
        if (checkthis(center2,check1)) {
            Toast.makeText(this, "checkthis true", Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(this, "checkthis false", Toast.LENGTH_SHORT).show();
        }
        LatLng check=new LatLng(-1.199922197330275,36.90031751990318);
        LatLng center=new LatLng( -1.198501943525175,36.90164655447006);
        if(arePointsNear(check,center,1)){
...
*/
    ...
    private PendingIntent createGeofencePendingIntent() {
        ...
        Intent intent = new Intent( this, GeofenceTrasitionServiceb.class);
